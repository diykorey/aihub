...
credentials are missing. See [Backend Setup](guides/backend-setup.md) for the full guide.

## Development phases

The backlog is delivered in 8 phases (see [Dev Tickets](backlog/dev-tickets.md)):
...
See [Phase 1 — Backend Core](phases/phase-1-backend-core.md) for the detailed record of
what Phase 1 delivered, and the [Glossary](glossary.md) for definitions of the domain
